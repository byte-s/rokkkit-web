  ...
  return (
      <>
        ...
        <div className="py-10">
          ...
          <p className="text-lg">
            1С-Битрикс: Управление сайтом — система управления контентом веб-проекта (CMS) от российской компании
            «Битрикс».
            <br/>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
            <div className="col-span-2 grid lg:grid-cols-2 gap-4">
              <div className="hover:scale-105 transition duration-300 bg-gray-100 dark:bg-gray-900 rounded-xl p-8">
                ...
                <div className="text-base">
                  Распределение
                  нагрузки между серверами и быстрая загрузка страниц.
                </div>
              </div>
              <div className="hover:scale-105 transition duration-300 bg-gray-100 dark:bg-gray-900 rounded-xl p-8">
                ...
                <div className="text-base">
                  Целый ряд технических решений по обеспечению безопасности системы.
                </div>
              </div>
              <div className="hover:scale-105 transition duration-300 bg-gray-100 dark:bg-gray-900 rounded-xl p-8">
                ...
                <div className="text-base">
                  Возможность создания нескольких сайтов в рамках одной лицензии.
                </div>
              </div>
              <div className="hover:scale-105 transition duration-300 bg-gray-100 dark:bg-gray-900 rounded-xl p-8">
            ...
            <div className="hover:scale-105 transition duration-300 col-span-2 bg-gray-100 dark:bg-gray-900 rounded-xl p-8 lg:p-10 items-center justify-center flex flex-col">
              ...
              <p className={"mt-4 font-medium"}>
                ...
                вебсайтах, согласно рейтингу iTrack (на март 2021 года).
              </p>
