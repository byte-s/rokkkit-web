        ...
        <div className="items-start space-y-2 ">
          <div className="flex flex-col items-start pt-8">
            <div className='items-center justify-center text-center'>
              <h4 className={styles.callHead+` text-gray-900 dark:text-gray-100`}>
                Поработаем вместе? Оставляйте заявку, а мы бесплатно проконсультируем, расскажем о процессах, подготовим КП
              </h4>
              <a href='/contacts' className={styles.callLink+` hover:animate-shake text-lg leading-9 text-gray-500 dark:text-gray-400`}>
              Свяжитесь с нами
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 42 42" fill="currentColor" className="h-6 w-6 text-gray-500 dark:text-gray-400">
