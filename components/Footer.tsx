      ...
      <div className="columns-3 mb-4 mt-16 flex space-x-2 justify-between items-center">
        ...
        <div className="mb-3 flex space-x-4">
            <a href="mailto:rokkitstudio@gmail.com">
              <svg width="20" height="17" viewBox="0 0 20 16" xmlns="http://www.w3.org/2000/svg" className="hover:animate-jump hover:animate-once hover:animate-ease-out text-sm text-gray-900 transition hover:text-gray-600 h-4 w-4">
            ...
            <a href="https://t.me/rokkit4business">
              <svg width="16" height="17" viewBox="0 0 16 17" xmlns="http://www.w3.org/2000/svg" className="hover:animate-jump hover:animate-once hover:animate-ease-out text-sm text-gray-900 transition hover:text-gray-600 h-4 w-4">
